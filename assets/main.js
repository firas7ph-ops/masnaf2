...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-4', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: true });
		onvisible.add('.icons-component.style-2', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: true });
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: true });
		onvisible.add('.icons-component.style-1', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: true });
		onvisible.add('.text-component.style-6', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.style-8', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: true });
		onvisible.add('.buttons-component.style-2', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: true });
